(function($, window, undefined){
  ...
  Hangman = {
    ...
    win: function(){
      ...
      this.msgTitle.html("Kazandınız!");
      
      this.msgText.html("Kelimeyi buldunuz <span class='highlight'>" + rating.guesses + "</span> Tahmin!<br>Yüzdelik Başarı: <span class='highlight'>" + rating.rating + "%</span>");
      this.showMsg();
    ...
    lose: function(){
      this.msgTitle.html("Kaybettiniz .. Kelime :<span class='highlight'>"+ this.wrd.word +"</span>");
      this.msgText.html("Endişelenme, bir sonrakini alacaksın!");
      this.showMsg();
  ...
  var wordList = ["elma","armut","mandalina","portakal","armut","muz","ayva","kivi","üzüm","kiraz","vişne"];
